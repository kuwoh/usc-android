...
SkinConfig::SkinConfig(const String& skin)
{
	...
	File defFile;
	String configPath = Path::Normalize("/sdcard/.usc/"+"skins/" + skin + "/config-definitions.json");
	//Log(configPath);
    ...
    InitDefaults();
	Load(Path::Normalize("/sdcard/.usc/"+"skins/" + skin + "/skin.cfg"));
}
...
SkinConfig::~SkinConfig()
{
	...
	Save(Path::Normalize("/sdcard/.usc/"+"skins/" + m_skin + "/skin.cfg"));
